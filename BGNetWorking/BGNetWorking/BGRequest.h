...
FOUNDATION_EXPORT NSString *const BGRequestCacheErrorDomain;

NS_ENUM(NSInteger) {
    BGRequestCacheErrorExpired = -1,
    BGRequestCacheErrorVersionMismatch = -2,
    BGRequestCacheErrorSensitiveDataMismatch = -3,
    BGRequestCacheErrorAppVersionMismatch = -4,
    BGRequestCacheErrorInvalidCacheTime = -5,
    BGRequestCacheErrorInvalidMetadata = -6,
    BGRequestCacheErrorInvalidCacheData = -7,
    };
    
    ///  BGRequest is the base class you should inherit to create your own request class.
    ///  Based on BGBaseRequest, BGRequest adds local caching feature. Note download
    ...
    @interface BGRequest : BGBaseRequest
